<?php
// tables_data.php - API endpoint for fetching table data
...
// Map sort columns to SQL columns for each table type
$sortColumnMap = [
    'art-styles' => [
        'id' => 'ast.id',
...
$sortColumn = 'image_count'; // Default
...
switch ($table) {
    case 'art-styles':
        // Art Styles: ID, Style String, Image Count
        $sql = "
            SELECT 
                ast.id,
                ast.style_string,
    ...
    case 'positive-prompts':
        // Positive Prompts: ID, Prompt Text, Combinations Count, Image Count
        $sql = "
            SELECT 
                pp.id,
                pp.prompt_text,
    ...
    case 'negative-prompts':
        // Negative Prompts: ID, Prompt Text, Combinations Count, Image Count
        $sql = "
            SELECT 
                np.id,
                np.prompt_text,
    ...
    case 'tokens':
        // Tokens: ID, Token, Positive Prompt Count, Negative Prompt Count
        $sql = "
            SELECT 
                t.id,
                t.token,
