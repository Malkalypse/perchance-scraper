...
class APIClient {
	...
	constructor( baseURL = '', defaultOptions = {} ) {
		console.log( 'APIClient initialized with baseURL:', baseURL, 'and defaultOptions:', defaultOptions );
	...
	_buildURL( endpoint, params = {} ) {
		console.log( 'Building URL for endpoint:', endpoint, 'with params:', params );
	...
	async _request( url, options = {} ) {
		console.log( 'Making request to URL:', url, 'with options:', options );
	...
	async get( endpoint, params = {}, options = {} ) {
		console.log( 'GET request to endpoint:', endpoint, 'with params:', params, 'and options:', options );	
	...
	async post( endpoint, data = {}, options = {} ) {
		console.log( 'POST request to endpoint:', endpoint, 'with data:', data, 'and options:', options );
	...
	/**
	 * Makes a PUT request.
	 * - Creates or completely replaces a resource at the specified endpoint.
	 * @param {string} endpoint - The API endpoint
	 * @param {Object} data     - Request body data
	 * @param {Object} options  - Additional fetch options
	 * @returns {Promise<Object>} Response data
	...
	async put( endpoint, data = {}, options = {} ) {
		console.log( 'PUT request to endpoint:', endpoint, 'with data:', data, 'and options:', options );
	...
	async delete( endpoint, data = null, options = {} ) {
		console.log( 'DELETE request to endpoint:', endpoint, 'with data:', data, 'and options:', options );
	...
	async patch( endpoint, data = {}, options = {} ) {
		console.log( 'PATCH request to endpoint:', endpoint, 'with data:', data, 'and options:', options );
	 ...
	 */
	removeHeader( key ) {
		console.log( `Removing default header: ${key}` );
	...
	setAuth( token, type = 'Bearer' ) {
		console.log( `Setting authorization header: ${type} ${token}` );
