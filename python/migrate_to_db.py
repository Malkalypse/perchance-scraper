...
def main():
    ...
    # Update table counts cache for web interface
    ...
    try:
        ...
        print( f"Warning: Failed to update table counts cache: {e.stderr}" )
    except Exception as e:
        print( f"Warning: Failed to update table counts cache: {e}" )
